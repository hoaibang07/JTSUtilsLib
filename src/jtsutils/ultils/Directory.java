...
public class Directory {
	...
	/**
	 * Lay ve duong dan cua thu muc hien tai ex: /home/hbc/(linux) or
	 * D:\hbc\(windows)
	 * 
	 * @return Tra ve duong dan cua thu muc bin neu o che do debug cua ide neu
	 *         release thanh file jar thi tra ve duong dan chua file jar
	 */
	public static String getCurrentDirectory() {
		try {
			// return URLDecoder.decode((new
			// File(Directory.class.getProtectionDomain().getCodeSource().getLocation().getPath())
